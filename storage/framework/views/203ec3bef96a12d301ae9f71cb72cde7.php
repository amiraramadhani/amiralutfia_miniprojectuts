<?php $__env->startSection('content'); ?>
    <div class="container w-50 mt-3 px-4 py-4 rounded-4 bg-light mt-3">
        ...
        <div">
            <form class="row g-3 pt-3" action="<?php echo e(route('barangs.store')); ?>" method="POST">
                <?php echo csrf_field(); ?>
                <div class="col-md-6">
                ...
                <div class="col-12">
                    <a class="btn btn-sm btn-outline-dark px-4 mt-3" href="<?php echo e(route('barangs.index')); ?>">Kembali</a>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp2\htdocs\mini_project\masterBarangUts\masterBarangUts\resources\views/Barang/create.blade.php ENDPATH**/ ?>