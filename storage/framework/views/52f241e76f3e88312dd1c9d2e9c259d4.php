<?php $__env->startSection('content'); ?>
    <div class="container w-50 mt-3 px-4 py-4 bg-light">
        ...
        <div>
            <form class="row g-3 pt-3" action="<?php echo e(route('barangs.update', $barang->id)); ?>" method="POST">
                <?php echo csrf_field(); ?>
                <?php echo method_field('PUT'); ?>
                <div class="col-md-6">
                    <label for="kode_barang" class="form-label">Kode Barang</label>
                    <input type="text" name="kode_barang" value="<?php echo e($barang->kode_barang); ?>" class="form-control"
                        id="kode_barang" readonly>
                </div>
                <div class="col-md-6">
                    <label for="nama_barang" class="form-label">Nama Barang</label>
                    <input type="text" name="nama_barang" value="<?php echo e($barang->nama_barang); ?>" class="form-control"
                        id="nama_barang" requaired>
                </div>
                <div class="col-md-6">
                    <label for="harga_barang" class="form-label">Harga</label>
                    <input type="number" name="harga_barang" value="<?php echo e($barang->harga_barang); ?>" class="form-control"
                ...
                <div class="col-md-12">
                    ...
                    <textarea name="deskripsi_barang" class="form-control" id="deskripsi_barang" cols="30" rows="3" requaired><?php echo e($barang->deskripsi_barang); ?></textarea>
                </div>
                <div class="col-12">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp2\htdocs\mini_project\masterBarangUts\masterBarangUts\resources\views/Barang/edit.blade.php ENDPATH**/ ?>